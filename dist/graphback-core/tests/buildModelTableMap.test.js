...
test('should build model-table mapping using default values', () => {
    ...
    const userModel = schema.getType("User");
...
test('should build mapping using custom values from mapping annotations', () => {
    ...
    expect(modelTableMap.fieldMap).toEqual({ email: 'user_email', name: 'userName', accountConfirmed: 'AccountConfirmed' });
...
//# sourceMappingURL=buildModelTableMap.test.js.map