...
import { BigIntResolver, ByteResolver, CurrencyResolver, DurationResolver, EmailAddressResolver, GUIDResolver, HSLAResolver, HSLResolver, HexColorCodeResolver, HexadecimalResolver, IBANResolver, IPv4Resolver, IPv6Resolver, ISBNResolver, ISO8601DurationResolver, LocalDateResolver, LocalTimeResolver, MACResolver, NegativeFloatResolver, NegativeIntResolver, NonEmptyStringResolver, NonNegativeFloatResolver, NonNegativeIntResolver, PhoneNumberResolver, PortResolver, PositiveFloatResolver, PositiveIntResolver, PostalCodeResolver, RGBAResolver, RGBResolver, URLResolver, USCurrencyResolver, UUIDResolver, UtcOffsetResolver, DIDResolver, LatitudeResolver, JWTResolver, LongitudeResolver, LocalEndTimeResolver, NonPositiveFloatResolver, NonPositiveIntResolver, TimeResolver, TimestampResolver, DateResolver, DateTimeResolver, ObjectIDResolver, JSONResolver, JSONObjectResolver } from 'graphql-scalars';
...
export const GraphbackObjectID = new GraphQLScalarType({
    ...
    parseLiteral: (ast, variables) => parseObjectID(parseLiteral(ast, variables))
});
 ...
 */
export function isSpecifiedGraphbackScalarType(type) {
 ...
 * @param type - GraphQL type
 */
export function isSpecifiedGraphbackJSONScalarType(type) {
