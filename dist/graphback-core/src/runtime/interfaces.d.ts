 ...
 */
export declare type DataProviderCreator = (model: ModelDefinition) => GraphbackDataProvider;
/**
 * Creator method that can be used by underlying implementation to create new data service
 */
export declare type ServiceCreator = (model: ModelDefinition, dataProvider: GraphbackDataProvider) => GraphbackCRUDService;
