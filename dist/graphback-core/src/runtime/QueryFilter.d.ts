...
declare type GraphbackScalarInput = BigIntInput | ByteInput | CurrencyInput | DIDInput | DurationInput | EmailAddressInput | GUIDInput | HSLInput | HSLAInput | HexColorCodeInput | HexadecimalInput | IBANInput | IPv4Input | IPv6Input | ISBNInput | ISO8601DurationInput | LatitudeInput | LocalDateInput | LocalEndTimeInput | LocalTimeInput | LongitudeInput | MACInput | NegativeFloatInput | NegativeIntInput | NonEmptyStringInput | NonNegativeFloatInput | NonNegativeIntInput | NonPositiveFloatInput | NonPositiveIntInput | PhoneNumberInput | PortInput | PositiveFloatInput | PositiveIntInput | PostalCodeInput | RGBAInput | RGBInput | URLInput | USCurrencyInput | UUIDInput | UtcOffsetInput | DateInput | DateTimeInput | GraphbackObjectIdInput | TimeInput | TimestampInput;
