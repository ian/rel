...
import { cypherDeleteMany } from "./helpers/deleteMany.js"
...
import { cypherUpdateMany } from "./helpers/updateMany.js"
...
export class Client {
  ...
  updateMany = cypherUpdateMany.bind(this)
  findOrCreate = cypherFindOrCreate.bind(this)
  delete = cypherDelete.bind(this)
  deleteMany = cypherDeleteMany.bind(this)
